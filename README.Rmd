...
This package makes a call to the Google PageSpeed Insights API and returns a data frame of results. This means you can programatically retrieve all of the analysis points accessible via the [Google PageSpeed Insights webpage](https://developers.google.com/speed/pagespeed/insights/?url=http%3A%2F%2Fwww.rstudio.com)
